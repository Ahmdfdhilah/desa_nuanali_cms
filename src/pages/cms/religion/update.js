...
const UpdateReligion = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                setLoading(true);
                const response = await axios.get(`https://nuniali-51afdf69a4d2.herokuapp.com/religions/${id}`, {
                    headers: {
    ...
    const onSubmit = async (e) => {
        ...
        setModalAction(() => async () => {
            try {
                ...
                await axios.put(`https://nuniali-51afdf69a4d2.herokuapp.com/religions/${id}`, formData, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
        ...
        setModalMessage('Apakah Anda yakin ingin memperbarui data agama ini?');
        setModalShow(true);
    };
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-10 mt-32">
                <h1 className="text-4xl font-bold mb-8 text-center">Update Agama</h1>
