    ...
    const onSubmit = async (e) => {
        ...
        setModalAction(() => async () => {
            try {
                ...
                await axios.post('https://nuniali-51afdf69a4d2.herokuapp.com/religions', formData, {
                    headers: {
        ...
        setModalMessage('Apakah Anda yakin ingin membuat agama ini?');
        setModalShow(true);
    };
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-10 mt-32">
                <h1 className="text-4xl font-bold mb-8 text-center">Buat Agama Baru</h1>
