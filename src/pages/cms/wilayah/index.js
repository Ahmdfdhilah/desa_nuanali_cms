...
const WilayahTable = () => {
    ...
    const handleCreateNew = () => {
        navigate('/admin/wilayah/create');
    };

    const handleEdit = (id) => {
        navigate(`/admin/wilayah/update/${id}`);
    };
        ...
        <>
            ...
            <div className="overflow-x-auto my-32 px-6">
                <div className="flex justify-between mb-6">
                    <h2 className="text-2xl font-semibold text-gray-800">Wilayah</h2>
                    <button
                ...
                <div className="mb-4 flex items-center">
                    ...
                    >
                        ...
                        <option value="name">Nama Dusun</option>
                        <option value="total">Total Penduduk</option>
                    </select>
                    <select
                        value={query.order || ''}
                ...
                <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                    <thead className="bg-gray-800 text-white">
                        <tr>
                            ...
                            <th className="text-left py-3 px-4 uppercase font-semibold text-sm">Nama Dusun</th>
                            <th className="text-left py-3 px-4 uppercase font-semibold text-sm">RT</th>
                            <th className="text-left py-3 px-4 uppercase font-semibold text-sm">KK</th>
                            <th className="text-left py-3 px-4 uppercase font-semibold text-sm">Laki-laki</th>
                            <th className="text-left py-3 px-4 uppercase font-semibold text-sm">Perempuan</th>
                        ...
                        {data.map((item, index) => (
                            <React.Fragment key={item.id}>
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4">{item.kk}</td>
                                        ...
                                        <td colSpan="8" className="py-4 px-6">
                                            <div className="flex justify-between">
                                                <div>
                                                    ...
                                                    <p><span className="font-semibold">Nama Dusun:</span> {item.name}</p>
                                                    <p><span className="font-semibold">RT:</span> {item.rt}</p>
                                                    <p><span className="font-semibold">KK:</span> {item.kk}</p>
                                                    <p><span className="font-semibold">Laki-laki:</span> {item.male}</p>
                                                    <p><span className="font-semibold">Perempuan:</span> {item.female}</p>
