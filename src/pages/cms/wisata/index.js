...
const WisataTable = () => {
    ...
    const handleCreateNew = () => {
        navigate('/admin/wisata/create');
    };

    const handleEdit = (id) => {
        navigate(`/admin/wisata/update/${id}`);
    };
        ...
        <>
            ...
            <div className="overflow-x-auto my-32 px-6">
                <div className="flex justify-between mb-6">
                    <h2 className="text-2xl font-semibold text-gray-800">Wisata</h2>
                    <button
                                ...
                                >
                                    ...
                                    <td className="py-3 px-4">
                                        {item.foto && item.foto.length > 0 ? (
                                            <FotoManager gambarUrls={item.foto} onUpdate={handleFotoUpdate} name="wisata" id={item.id} />
                                        ) : (
                                        ...
                                        <td colSpan="7" className="py-4 px-6">
                                            <div className="flex justify-between">
                                                <div>
                                                    ...
                                                    <p><span className="font-semibold">Deskripsi:</span> {item.description}</p>
                                                </div>
                                                <button
            ...
            <ConfirmationModal
                ...
                message="Apakah Anda yakin ingin menghapus wisata ini?"
            />
