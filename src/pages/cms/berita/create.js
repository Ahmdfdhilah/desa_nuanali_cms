...
const CreateBerita = () => {
    ...
    const onSubmit = async (e) => {
        ...
        modalMessageRef.current = 'Apakah Anda yakin ingin membuat berita ini?';
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-10 mt-32">
                <h1 className="text-4xl font-bold mb-8 text-center">Create New Berita</h1>
                <form onSubmit={onSubmit} className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
                    ...
                    <div className="mb-6">
                        ...
                        />
                        {formErrors.image && <p class
                            Name="text-red-500 text-sm mt-1">{formErrors.image}</p>}
                    </div>
