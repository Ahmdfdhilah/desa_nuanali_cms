...
const PrestasiTable = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://nuniali-51afdf69a4d2.herokuapp.com/prestasi', { params: query });
    ...
    const handleDelete = async () => {
        setLoading(true);
        try {
            await axios.delete(`https://nuniali-51afdf69a4d2.herokuapp.com/prestasi/${toBeDeletedId}`, {
                headers: {
    ...
    const handleCreateNew = () => {
        navigate('/admin/prestasi/create');
    };

    const handleEdit = (id) => {
        navigate(`/admin/prestasi/update/${id}`);
    };
        ...
        <>
            ...
            <div className="overflow-x-auto my-32 px-6">
                <div className="flex justify-between mb-6">
                    <h2 className="text-2xl font-semibold text-gray-800">Prestasi</h2>
                    <button
