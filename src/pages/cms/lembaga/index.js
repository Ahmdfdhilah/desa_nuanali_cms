...
const LembagaTable = () => {
    ...
    const handleCreateNew = () => {
        navigate('/admin/lembaga/create');
    };

    const handleEdit = (id) => {
        navigate(`/admin/lembaga/update/${id}`);
    };
        ...
        <>
            ...
            <div className="overflow-x-auto my-32 px-6">
                <div className="flex justify-between mb-6">
                    <h2 className="text-2xl font-semibold text-gray-800">Lembaga</h2>
                    <button
                                        ...
                                        <td colSpan="7" className="py-4 px-6">
                                            <div className="flex justify-between">
                                                <div>
                                                    ...
                                                    <p><span className="font-semibold">Kontak:</span> {item.contact}</p>
            ...
            <ConfirmationModal
                show={modalShow}
                title="Hapus Lembaga"
                message="Apakah Anda yakin ingin menghapus lembaga ini?"
