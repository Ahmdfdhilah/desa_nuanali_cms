...
const UpdateUsia = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                setLoading(true);
                const response = await axios.get(`https://nuniali-51afdf69a4d2.herokuapp.com/usias/${id}`, {
                    headers: {
    ...
    const onSubmit = async (e) => {
        ...
        setModalAction(() => async () => {
            try {
                ...
                await axios.put(`https://nuniali-51afdf69a4d2.herokuapp.com/usias/${id}`, formData, {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                ...
                console.error('Error updating usia:', error);
                setLoading(false);
            }
        });
        setModalTitle('Konfirmasi');
        setModalMessage('Apakah Anda yakin ingin memperbarui data usia ini?');
        setModalShow(true);
    };
    ...
    return (
        <>
            ...
            <div className="container mx-auto py-10 mt-32">
                <h1 className="text-4xl font-bold mb-8 text-center">Update Usia</h1>
